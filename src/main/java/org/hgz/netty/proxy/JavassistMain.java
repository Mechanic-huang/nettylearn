...
public class JavassistMain {
  ...
  public static void main(String[] args) throws NotFoundException, CannotCompileException {
    ...
    CtClass ctClass = pool.makeClass ("org.hgz.netty.proxy.StationProxy");

    CtClass interface1 = pool.get ("org.hgz.netty.proxy.TicketService");
    // 设置类实现的接口
    ctClass.setInterfaces (new CtClass[]{interface1});

    // 设置类的field
    CtField field = CtField.make ("private org.hgz.netty.proxy.Station station;", ctClass);
